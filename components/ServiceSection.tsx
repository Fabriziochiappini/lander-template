...
const ServiceSection: React.FC<ServiceSectionProps> = ({ services, title, subtitle }) => {
  return (
    <section className="bg-zinc-900 text-white py-24 -mx-6 px-6 md:-mx-12 md:px-12 lg:-mx-24 lg:px-24 mt-32 rounded-[3rem] shadow-inner">
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-20">
          <h2 className="text-4xl md:text-5xl font-serif font-bold mb-6">{title || 'Servizi di Elite Digital Strategy'}</h2>
          <p className="text-zinc-400 max-w-2xl mx-auto text-lg md:text-xl font-light">
            {subtitle || 'Sviluppiamo ecosistemi digitali che combinano estetica superiore e ingegneria Next.js ad alte prestazioni.'}
          </p>
        </div>
